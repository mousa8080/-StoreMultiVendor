<div class="cart-items">
    ...
    <div class="shopping-item">
        <div class="dropdown-cart-header">
            ...
            <a href="{{ route('card.index') }}">View Cart</a>
        </div>
                ...
                <li>
                    ...
                    <div class="content">
                        ...
                        <p class="quantity ">{{ $item->quantity }}x - <span
                                class="amount">{{ app(\App\Helpers\Currency::class)->format($item->product->price) }}</span>
                        </p>
                    </div>
                </li>
            @endforeach
        ...
        <div class="bottom">
            <div class="total">
                <span>Total</span>
                <span class="total-amount">{{ app(\App\Helpers\Currency::class)->format($total) }}</span>
            </div>
            <div class="button">
