                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-6 col-md-12 col-12">
                        <div class="product-info">
                            ...
                            <h3 class="price">{{app(App\Helpers\Currency::class)->format($product->price, 'SAR')}}
                                @if($product->discount_percentage)
                                <span>{{app(App\Helpers\Currency::class)->format($product->discount_percentage)}}</span> @endif
                            </h3>
