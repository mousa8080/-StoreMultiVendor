...
namespace PHPSTORM_META {
    ...
    */
    override(new \Illuminate\Contracts\Container\Container, map([
        '' => '@',
            'App\Repositories\card\CardRepositories' => \App\Repositories\card\CardModelRepositories::class,
    ...
    override(\config(), map([
            ...
            'filesystems.disks.uploads.throw' => 'boolean',
            'filesystems.disks.uploads.report' => 'boolean',
            'filesystems.links.C:\xampp\htdocs\laravel1\STORE\STORE\public\storage' => 'string',
...
'app.aliases.View','app.aliases.Vite','app.aliases.Currency','app.currency','app',
'auth.defaults.guard','auth.defaults.passwords','auth.guards.web.driver','auth.guards.web.provider','auth.guards.admin.driver',
'auth.guards.admin.provider','auth.providers.users.driver','auth.providers.users.model','auth.providers.admins.driver','auth.providers.admins.model',
...
'filesystems.disks.uploads.visibility','filesystems.disks.uploads.throw','filesystems.disks.uploads.report','filesystems.links.C:\\xampp\\htdocs\\laravel1\\STORE\\STORE\\public\\storage','fortify.guard',
...
'mail.markdown.theme','mail.markdown.paths','nav.0.icon','nav.0.route','nav.0.title',
'nav.1.icon','nav.1.route','nav.1.title','nav.2.icon','nav.2.route',
'nav.2.title','nav.2.badge','queue.default','queue.connections.sync.driver','queue.connections.database.driver',
...
'home','products','product.show','card.index','card.create',
'card.store','card.show','card.edit','card.update','card.destroy',
'checkout','profile.edit','profile.update','profile.destroy',
'dashpoard.dashboard','dashpoard.profile.edit','dashpoard.profile.update','dashpoard.categories.trashed','dashpoard.categories.restore',
'dashpoard.categories.forceDelete','dashpoard.categories.index','dashpoard.categories.create','dashpoard.categories.store','dashpoard.categories.show',
'dashpoard.categories.edit','dashpoard.categories.update','dashpoard.categories.destroy','dashpoard.products.index','dashpoard.products.create',
'dashpoard.products.store','dashpoard.products.show','dashpoard.products.edit','dashpoard.products.update','dashpoard.products.destroy','storage.local',);
        registerArgumentsSet('views', 
'auth.confirm-password','auth.forgot-password','auth.login','auth.register','auth.reset-password',
'auth.verify-email','components.alert','components.application-logo','components.auth-session-status','components.card-minue',
'components.danger-button','components.dashboard.notification-menu','components.dropdown','components.dropdown-link','components.form.input',
'components.form.label','components.form.radio','components.form.selected','components.form.textarea','components.input-error',
'components.input-label','components.modal','components.nav','components.nav-link','components.primary-button',
'components.product-card','components.responsive-nav-link','components.secondary-button','components.text-input','dashboard',
'dashpoard.Categories.__form','dashpoard.Categories.create','dashpoard.Categories.edit','dashpoard.Categories.index','dashpoard.Categories.show',
'dashpoard.Categories.trash','dashpoard.index','dashpoard.products.__form','dashpoard.products.create','dashpoard.products.edit',
'dashpoard.products.index','dashpoard.profile.edit','front.auth.login','front.auth.register','front.card',
'front.checkout','front.home','front.products.show','layouts.app','layouts.dashposrd',
'layouts.front','layouts.guest','layouts.navigation','layouts.partials.nav','notifications::email',
'pagination.custom','pagination::bootstrap-4','pagination::bootstrap-5','pagination::default','pagination::semantic-ui',
...
'profile.edit','profile.partials.delete-user-form','profile.partials.update-password-form','profile.partials.update-profile-information-form','vendor.mail.html.button',
...
'C:.xampp.htdocs.laravel1.STORE.STORE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.failed','C:.xampp.htdocs.laravel1.STORE.STORE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.password','C:.xampp.htdocs.laravel1.STORE.STORE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.throttle','C:.xampp.htdocs.laravel1.STORE.STORE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.pagination.previous','C:.xampp.htdocs.laravel1.STORE.STORE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.pagination.next',
'C:.xampp.htdocs.laravel1.STORE.STORE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.reset','C:.xampp.htdocs.laravel1.STORE.STORE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.sent','C:.xampp.htdocs.laravel1.STORE.STORE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.throttled','C:.xampp.htdocs.laravel1.STORE.STORE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.token','C:.xampp.htdocs.laravel1.STORE.STORE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.user',
'C:.xampp.htdocs.laravel1.STORE.STORE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.accepted','C:.xampp.htdocs.laravel1.STORE.STORE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.accepted_if','C:.xampp.htdocs.laravel1.STORE.STORE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.active_url','C:.xampp.htdocs.laravel1.STORE.STORE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.after','C:.xampp.htdocs.laravel1.STORE.STORE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.after_or_equal',
'C:.xampp.htdocs.laravel1.STORE.STORE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha','C:.xampp.htdocs.laravel1.STORE.STORE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha_dash','C:.xampp.htdocs.laravel1.STORE.STORE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha_num','C:.xampp.htdocs.laravel1.STORE.STORE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.any_of','C:.xampp.htdocs.laravel1.STORE.STORE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.array',
'C:.xampp.htdocs.laravel1.STORE.STORE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ascii','C:.xampp.htdocs.laravel1.STORE.STORE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.before','C:.xampp.htdocs.laravel1.STORE.STORE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.before_or_equal','C:.xampp.htdocs.laravel1.STORE.STORE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.array','C:.xampp.htdocs.laravel1.STORE.STORE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.file',
'C:.xampp.htdocs.laravel1.STORE.STORE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.numeric','C:.xampp.htdocs.laravel1.STORE.STORE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.string','C:.xampp.htdocs.laravel1.STORE.STORE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.boolean','C:.xampp.htdocs.laravel1.STORE.STORE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.can','C:.xampp.htdocs.laravel1.STORE.STORE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.confirmed',
'C:.xampp.htdocs.laravel1.STORE.STORE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.contains','C:.xampp.htdocs.laravel1.STORE.STORE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.current_password','C:.xampp.htdocs.laravel1.STORE.STORE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date','C:.xampp.htdocs.laravel1.STORE.STORE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date_equals','C:.xampp.htdocs.laravel1.STORE.STORE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date_format',
'C:.xampp.htdocs.laravel1.STORE.STORE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.decimal','C:.xampp.htdocs.laravel1.STORE.STORE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.declined','C:.xampp.htdocs.laravel1.STORE.STORE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.declined_if','C:.xampp.htdocs.laravel1.STORE.STORE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.different','C:.xampp.htdocs.laravel1.STORE.STORE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.digits',
'C:.xampp.htdocs.laravel1.STORE.STORE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.digits_between','C:.xampp.htdocs.laravel1.STORE.STORE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.dimensions','C:.xampp.htdocs.laravel1.STORE.STORE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.distinct','C:.xampp.htdocs.laravel1.STORE.STORE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_contain','C:.xampp.htdocs.laravel1.STORE.STORE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_end_with',
'C:.xampp.htdocs.laravel1.STORE.STORE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_start_with','C:.xampp.htdocs.laravel1.STORE.STORE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.email','C:.xampp.htdocs.laravel1.STORE.STORE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ends_with','C:.xampp.htdocs.laravel1.STORE.STORE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.enum','C:.xampp.htdocs.laravel1.STORE.STORE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.exists',
'C:.xampp.htdocs.laravel1.STORE.STORE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.extensions','C:.xampp.htdocs.laravel1.STORE.STORE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.file','C:.xampp.htdocs.laravel1.STORE.STORE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.filled','C:.xampp.htdocs.laravel1.STORE.STORE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.array','C:.xampp.htdocs.laravel1.STORE.STORE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.file',
'C:.xampp.htdocs.laravel1.STORE.STORE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.numeric','C:.xampp.htdocs.laravel1.STORE.STORE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.string','C:.xampp.htdocs.laravel1.STORE.STORE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.array','C:.xampp.htdocs.laravel1.STORE.STORE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.file','C:.xampp.htdocs.laravel1.STORE.STORE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.numeric',
'C:.xampp.htdocs.laravel1.STORE.STORE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.string','C:.xampp.htdocs.laravel1.STORE.STORE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.hex_color','C:.xampp.htdocs.laravel1.STORE.STORE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.image','C:.xampp.htdocs.laravel1.STORE.STORE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in','C:.xampp.htdocs.laravel1.STORE.STORE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in_array',
'C:.xampp.htdocs.laravel1.STORE.STORE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in_array_keys','C:.xampp.htdocs.laravel1.STORE.STORE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.integer','C:.xampp.htdocs.laravel1.STORE.STORE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ip','C:.xampp.htdocs.laravel1.STORE.STORE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ipv4','C:.xampp.htdocs.laravel1.STORE.STORE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ipv6',
'C:.xampp.htdocs.laravel1.STORE.STORE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.json','C:.xampp.htdocs.laravel1.STORE.STORE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.list','C:.xampp.htdocs.laravel1.STORE.STORE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lowercase','C:.xampp.htdocs.laravel1.STORE.STORE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.array','C:.xampp.htdocs.laravel1.STORE.STORE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.file',
'C:.xampp.htdocs.laravel1.STORE.STORE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.numeric','C:.xampp.htdocs.laravel1.STORE.STORE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.string','C:.xampp.htdocs.laravel1.STORE.STORE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.array','C:.xampp.htdocs.laravel1.STORE.STORE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.file','C:.xampp.htdocs.laravel1.STORE.STORE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.numeric',
'C:.xampp.htdocs.laravel1.STORE.STORE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.string','C:.xampp.htdocs.laravel1.STORE.STORE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mac_address','C:.xampp.htdocs.laravel1.STORE.STORE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.array','C:.xampp.htdocs.laravel1.STORE.STORE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.file','C:.xampp.htdocs.laravel1.STORE.STORE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.numeric',
'C:.xampp.htdocs.laravel1.STORE.STORE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.string','C:.xampp.htdocs.laravel1.STORE.STORE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max_digits','C:.xampp.htdocs.laravel1.STORE.STORE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mimes','C:.xampp.htdocs.laravel1.STORE.STORE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mimetypes','C:.xampp.htdocs.laravel1.STORE.STORE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.array',
'C:.xampp.htdocs.laravel1.STORE.STORE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.file','C:.xampp.htdocs.laravel1.STORE.STORE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.numeric','C:.xampp.htdocs.laravel1.STORE.STORE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.string','C:.xampp.htdocs.laravel1.STORE.STORE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min_digits','C:.xampp.htdocs.laravel1.STORE.STORE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing',
'C:.xampp.htdocs.laravel1.STORE.STORE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_if','C:.xampp.htdocs.laravel1.STORE.STORE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_unless','C:.xampp.htdocs.laravel1.STORE.STORE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_with','C:.xampp.htdocs.laravel1.STORE.STORE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_with_all','C:.xampp.htdocs.laravel1.STORE.STORE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.multiple_of',
'C:.xampp.htdocs.laravel1.STORE.STORE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.not_in','C:.xampp.htdocs.laravel1.STORE.STORE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.not_regex','C:.xampp.htdocs.laravel1.STORE.STORE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.numeric','C:.xampp.htdocs.laravel1.STORE.STORE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.letters','C:.xampp.htdocs.laravel1.STORE.STORE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.mixed',
'C:.xampp.htdocs.laravel1.STORE.STORE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.numbers','C:.xampp.htdocs.laravel1.STORE.STORE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.symbols','C:.xampp.htdocs.laravel1.STORE.STORE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.uncompromised','C:.xampp.htdocs.laravel1.STORE.STORE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present','C:.xampp.htdocs.laravel1.STORE.STORE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_if',
'C:.xampp.htdocs.laravel1.STORE.STORE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_unless','C:.xampp.htdocs.laravel1.STORE.STORE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_with','C:.xampp.htdocs.laravel1.STORE.STORE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_with_all','C:.xampp.htdocs.laravel1.STORE.STORE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited','C:.xampp.htdocs.laravel1.STORE.STORE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if',
'C:.xampp.htdocs.laravel1.STORE.STORE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if_accepted','C:.xampp.htdocs.laravel1.STORE.STORE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if_declined','C:.xampp.htdocs.laravel1.STORE.STORE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_unless','C:.xampp.htdocs.laravel1.STORE.STORE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibits','C:.xampp.htdocs.laravel1.STORE.STORE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.regex',
'C:.xampp.htdocs.laravel1.STORE.STORE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required','C:.xampp.htdocs.laravel1.STORE.STORE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_array_keys','C:.xampp.htdocs.laravel1.STORE.STORE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if','C:.xampp.htdocs.laravel1.STORE.STORE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if_accepted','C:.xampp.htdocs.laravel1.STORE.STORE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if_declined',
'C:.xampp.htdocs.laravel1.STORE.STORE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_unless','C:.xampp.htdocs.laravel1.STORE.STORE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_with','C:.xampp.htdocs.laravel1.STORE.STORE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_with_all','C:.xampp.htdocs.laravel1.STORE.STORE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_without','C:.xampp.htdocs.laravel1.STORE.STORE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_without_all',
'C:.xampp.htdocs.laravel1.STORE.STORE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.same','C:.xampp.htdocs.laravel1.STORE.STORE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.array','C:.xampp.htdocs.laravel1.STORE.STORE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.file','C:.xampp.htdocs.laravel1.STORE.STORE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.numeric','C:.xampp.htdocs.laravel1.STORE.STORE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.string',
'C:.xampp.htdocs.laravel1.STORE.STORE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.starts_with','C:.xampp.htdocs.laravel1.STORE.STORE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.string','C:.xampp.htdocs.laravel1.STORE.STORE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.timezone','C:.xampp.htdocs.laravel1.STORE.STORE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.unique','C:.xampp.htdocs.laravel1.STORE.STORE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uploaded',
'C:.xampp.htdocs.laravel1.STORE.STORE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uppercase','C:.xampp.htdocs.laravel1.STORE.STORE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.url','C:.xampp.htdocs.laravel1.STORE.STORE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ulid','C:.xampp.htdocs.laravel1.STORE.STORE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uuid','C:.xampp.htdocs.laravel1.STORE.STORE.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.custom.attribute-name.rule-name',);
        registerArgumentsSet('env', 
'APP_NAME','APP_ENV','APP_KEY','APP_DEBUG','APP_URL',
'APP_DEVELOPER','APP_LOCALE','APP_FALLBACK_LOCALE','APP_FAKER_LOCALE','APP_MAINTENANCE_DRIVER',
...
'MAIL_PASSWORD','MAIL_ENCRYPTION','MAIL_FROM_ADDRESS','MAIL_FROM_NAME','PUSHER_APP_ID',
'PUSHER_APP_KEY','PUSHER_APP_SECRET','PUSHER_APP_CLUSTER','AWS_ACCESS_KEY_ID','AWS_SECRET_ACCESS_KEY',
